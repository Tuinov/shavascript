...
var BasicController = /** @class */ (function () {
    function BasicController(model) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = +req.params.id;
                        console.log('id', id);
                        return [4 /*yield*/, this.model.getOne(id)];
                    case 1:
                        userOne = _a.sent();
                        res.json(userOne);
                        return [2 /*return*/];
        ...
        this.update = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.model.update(req.body)];
                    case 1:
                        result = _a.sent();
                        res.json(result);
                        return [2 /*return*/];
    ...
    BasicController.prototype.getAll = function (req, res) {
    ...
    BasicController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var newItem;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.model.create(req.body)];
                    case 1:
                        newItem = _a.sent();
                        res.json(newItem);
                        return [2 /*return*/];
    ...
    ], BasicController.prototype, "getAll", null);
