...
var OrderController = /** @class */ (function (_super) {
    ...
    OrderController.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, OrderController_1.model.getAll()];
                    case 1:
                        products = _a.sent();
                        res.json(products);
                        return [2 /*return*/];
    ...
    OrderController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, OrderController_1.model.create(req.body)];
                    case 1:
                        newItem = _a.sent();
    ...
    //     super(new Order())
    // }
    OrderController.model = new Order_1.Order();
    __decorate([
